...
sed -i -e "s/DEBUG = False/DEBUG = True/g;/^MD5_PASSWD.*/s//MD5_PASSWD = '${md5passwd}'/g;/^BASE_URI.*/s//BASE_URI = '${host}'/g;/^SECRET_KEY.*/s//SECRET_KEY = '${secretkey}'/g" lxss/settings.py > settings.py
